...
`;
    ...
    this.headline = (this.todoListContainer.querySelector('.headline-title') as HTMLInputElement);
    this.inputID = (this.todoListContainer.querySelector('.add-item') as HTMLInputElement);
    this.buttonID = (this.todoListContainer.querySelector('.item-submit') as HTMLButtonElement);
    this.todoList = (this.todoListContainer.querySelector('.todo-list') as HTMLUListElement);
    this.removeList = (this.todoListContainer.querySelector('.clear') as HTMLButtonElement);
    this.deleteTodo = (this.todoListContainer.querySelector('.delete') as HTMLButtonElement);
  }
